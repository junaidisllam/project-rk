...
const sortDropdownOpen = ref(false); // State for custom select
    ...
    allTokensToHighlight.forEach((token) => {
        ...
        highlightedText = highlightedText.replace(
            ...
            (match, p1, offset, string) => {
                ...
                return `<span class="text-blue font-black">${p1}</span>`;
            },
        );
    });
...
<template>
    ...
    >
                    ...
                    >
                        ...
                        <div class="flex-1 overflow-y-auto px-6 py-4">
                            ...
                            <div class="relative mb-6">
                                ...
                                <input
                                    ...
                                    class="w-full rounded-2xl border-none bg-slate-100 py-3.5 pr-4 pl-12 text-sm font-medium focus:ring-2 focus:ring-blue-900/20"
                                />
                            </div>
                                ...
                                >
                                            ...
                                            <div
                                                ...
                                                :class="
                                                    isSelected(
                                                        ...
                                                        ? 'border-blue-900 bg-blue-900 shadow-md shadow-blue-900/20'
                                    ...
                                    >
                                        <input
                                            ...
                                            placeholder="Min"
                                            class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 text-center text-sm font-bold"
                                        />
                        ...
                        <div class="border-t border-gray-100 bg-white p-6 pb-8">
                            <button
                                ...
                                class="w-full rounded-2xl bg-blue-900 py-4 text-base font-bold text-white shadow-xl shadow-blue-900/20 transition-all active:scale-[0.98]"
                            >
        ...
        <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div
                class="sticky top-[60px] z-30 -mx-4 border-b border-gray-100 bg-white/90 shadow-sm backdrop-blur-md lg:hidden"
                style="z-index: 60"
            >
                <div class="flex items-center justify-between px-4 py-3">
                    <div class="flex items-center gap-2">
                        <SlidersHorizontal class="h-5 w-5 text-blue-900" />
                    ...
                    <button
                        ...
                        class="flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2 text-xs font-bold text-white shadow-lg shadow-slate-900/20 transition-transform active:scale-95"
                    >
                    ...
                    <aside class="hidden lg:col-span-1 lg:block">
                        <div class="sticky top-28 space-y-1">
                            ...
                            >
                                ...
                                >
                                    <Filter class="h-4 w-4 text-blue-900" />
                                    ফিল্টার সমূহ
                                </h3>
                                <button
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {{ section.name }}
                                        <div
                                            class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-50 transition-colors group-hover:bg-blue-50"
                                        >
                                            <ChevronDown
                                        ...
                                        >
                                            <div class="relative flex-1">
                                                ...
                                                <input
                                                    ...
                                                    class="w-full rounded-lg border-gray-200 bg-gray-50 py-2 pl-6 text-xs font-bold transition-all focus:border-blue-500 focus:ring-0"
                                                    placeholder="0"
                                                />
                                            </div>
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    :class="
                                                        isSelected(
                                                            ...
                                                            ? 'border-blue-900 bg-blue-900 shadow-md shadow-blue-900/30'
                            ...
                            >
                                <div class="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        class="w-full rounded-xl border-none bg-slate-50 py-3 pr-10 pl-11 text-sm font-medium transition-all focus:ring-2 focus:ring-blue-100"
                            ...
                            >
                                <TransitionGroup name="list">
                                    <div
                                        ...
                                        :key="cat"
                                        class="flex items-center gap-1.5 rounded-full bg-blue-50 px-3 py-1.5 text-xs font-bold text-blue-800 ring-1 ring-blue-900/10"
                                    >
                                        {{
                                            categories.find(
                                                (c) => c.slug === cat,
                        ...
                        <div class="relative min-h-[400px]">
                            ...
                            <Transition name="fade" mode="out-in">
                                ...
                                <div v-else>
                                    <div v-if="books && books.data.length > 0">
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    v-if="link.url === null"
                                                    class="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-sm font-medium text-gray-300"
                                                    v-html="link.label"
                                                />
                                                <button
                                                    v-else
                                                    ...
                                                    "
                                                    class="flex h-10 w-10 items-center justify-center rounded-xl text-sm font-bold shadow-sm transition-all duration-300"
                                                    :class="
                                                        link.active
                                                            ? 'scale-105 bg-slate-900 text-white shadow-slate-900/30'
                                                            : 'bg-white text-slate-600 hover:scale-105 hover:bg-blue-50 hover:text-blue-900'
                                                    "
                                                    v-html="link.label"
                                                />
                                            </template>
                                    ...
                                    >
                                        <div
                                            class="mb-6 rounded-full bg-blue-50 p-8 ring-8 ring-blue-50/50"
                                        >
                                            <BookOpen
                                        ...
                                        <button
                                            @click="resetFilters"
                                            class="rounded-xl bg-slate-900 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-slate-900/20 transition-colors hover:bg-slate-800"
                                        >
                                            ফিল্টার রিসেট করুন
                                        </button>
                                    </div>
